...
// this program normalize the words to reduce the diversity into it most common term as possible.

function ml_step3_text_normalization($arr_content){
    ...
    for($i = 0; $i < count($arr_content); $i++){
        ...
        for($h = 0; $h < strlen($arr_content[$i]); $h++){
            if (ord($arr_content[$i][$h]) >= 48 && ord($arr_content[$i][$h]) <= 57){
